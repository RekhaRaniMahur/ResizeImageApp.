...
wrapper5.pack(fill="both",expand="yes",padx=10,pady=20)

prvbtn=Button(wrapper5,text="Preview",command=preview_resize_img)
prvbtn.pack(side=tk.LEFT,padx=10,pady=10)

savebtn=Button(wrapper5,text="Save",command=save_resize_img)
